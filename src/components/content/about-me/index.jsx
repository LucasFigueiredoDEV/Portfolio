...
function Aboutme({ lang }) { 
  ...
  const translations = {
    en: {
      tag: "About me",
      title: "Fullstack Developer focused on performance and scalability",
    ...
    pt: {
      tag: "Sobre mim",
      title: "Desenvolvedor Fullstack focado em performance e escalabilidade",
    ...
    <section className="about" id="about">
      <div className="container">
        <div className="row align-items-center">
          ...
          <div className="col-12 col-lg-5 col-xl-5 col-xxl-5 col-md-12 text-center">
            <div className="about-img">
              <img src="/img/home-portfolio.png" alt="about" />
            </div>
          </div>

          <div className="col-12 col-lg-7 col-xl-7 col-xxl-7 col-md-12">
